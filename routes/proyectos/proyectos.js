...
var publications = require('../proyectos/proyectos.json');

/* GET users listing. */
router.get('/', function(req, res, next) {
	//console.log(publications.publicaciones);
	res.render('proyectos', {proyectos: 1, list: publications.publicaciones, act: publications.publicaciones[0], roster: roster.integrantes});
});
...
router.get('/:id', function(req, res, next) {
	...
	console.log(act);
	res.render('proyecto', {proyecto: 1, publication: act, roster: roster.integrantes});
});
